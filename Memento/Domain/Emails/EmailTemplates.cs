        ...
        private static string GetBody(EmailTypes name) {
            switch (name)
            {
                ...
                case EmailTypes.Login:
                    return @"<p>@Model.Name, click this <a href='" + Constants.BaseUrl + "/#/login?token=@Model.Token'>link</a> to log in to your Fyli account.</p>";
